  ...
  <div class="col-sm-1">
    ...
    <div class="col-sm-10" style="border: 2px solid black; padding:10px;">
    	<?php 
         ...
         <div class="row">
          <div class="col-2">
            <img src="img/logo3.jpg" class="img-fluid">
          </div>
           <div class="col">
              <div class="main-heading">Zaman Smarter Organization Education Hub</div>
     <p class="sub-heading"> Ministry of Corporate Affairs (Govt. of Bangla ) Govt. CIN. No. TS75200CP2921NPL TAN. TCPP90708E</p>
      <div class="address"> Hed.Office: A Sing,Mohan Nagar Prasad Road, Kushtia - 110056  Register office: Subhash Nagar Dehradoon Uttarakhand 248002
</div>
         <p class="email"> Email: contactmdzaman@gmail.com , Website: https://mzwd2.blogspot.com</p>
          </div>
          <div class="col-sm-12">
            <hr class="hrcls"> 
          </div>
